...
<div class="tutor-card tutor-card-md tutor-sidebar-card">
	<div class="tutor-card-body imheres product-info-box std-add-t-cart">
		<?php
		if ( $is_enrolled || $is_privileged_user) {
			...
			if ( ! $is_completed_course ) {
				...
				<form method="post" class="tutor-mt-20">
					...
					<button type="submit" class="tutor-btn tutor-btn-color-green tutor-btn-lg tutor-btn-block tutor-mt-24 tutor-add-to-cart-button" name="complete_course_btn" value="complete_course">
			...
			ob_start();
			?>
				<a href="<?php echo esc_url( $first_lesson_url ); ?>" class="tutor-btn tutor-btn-color-green tutor-btn-lg tutor-btn-block tutor-mt-24 tutor-add-to-cart-button">
			...
			if ( tutor_utils()->is_course_fully_booked( null ) ) {
				...
				ob_start();
					...
					tutor_load_template( 'template-part.add-to-cart-' . $tutor_course_sell_by );
				...
				?>
					...
					<div class="tutor-course-single-btn-group <?php echo is_user_logged_in() ? '' : 'tutor-course-entry-box-login'; ?>" data-login_url="<?php echo $login_url; ?>">
						<form class="tutor-enrol-course-form" method="post">
							...
							<button type="submit" class="tutor-btn tutor-btn-color-green tutor-btn-lg tutor-btn-block tutor-mt-24 tutor-add-to-cart-button">
...
<div class="card mt-3">
	...
	<div class="tutor-card-footer">
		<div class="total_sales">
                    ...
                    <span><?= $sidebar_meta[1]['value'];?></span>
        </div>
		<ul class="tutor-ul">
