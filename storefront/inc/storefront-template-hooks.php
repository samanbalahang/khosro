...
add_action( 'storefront_sidebar_sam', 'storefront_get_sidebar_sam', 10 );
add_action( 'storefront_sidebar_tutor_sam', 'storefront_get_tutor_sam', 10 );
...
add_action( 'storefront_header', 'storefront_secondary_navigation_right', 31 );
add_action( 'storefront_header', 'storefront_secondary_navigation_left', 31 );
