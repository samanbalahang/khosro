		...
		<nav id="site-navigation" class="main-navigation" role="navigation" aria-label="<?php esc_attr_e('Primary Navigation', 'storefront'); ?>">
			...
			wp_nav_menu(
				array(
					...
					'container_class' => 'right-navigation',
				)
			);
...
if (!function_exists('storefront_secondary_navigation_right')) {
	/**
	 * Display Secondary Navigation
	 *
	 * @since  1.0.0
	 * @return void
	 */
	function storefront_secondary_navigation_right()
	{
...
if (!function_exists('storefront_secondary_navigation_left')) {
	/**
	 * Display Secondary Navigation
	 *
	 * @since  1.0.0
	 * @return void
	 */
	function storefront_secondary_navigation_left()
	{
...
if (!function_exists('storefront_get_sidebar_sam')) {
	/**
	 * Display storefront sidebar
	 *
	 * @uses get_sidebar()
	 * @since 1.0.0
	 */
	function storefront_get_sidebar_sam()
	{
	?>
...
if (!function_exists('storefront_get_tutor_sam')) {
	/**
	 * Display storefront sidebar
	 *
	 * @uses get_sidebar()
	 * @since 1.0.0
	 */
	function storefront_get_tutor_sam()
	{
	?>
		<div id="secondary" class="main widget-area">
			<div class="card">
