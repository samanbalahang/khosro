...
if ( ! function_exists( 'storefront_before_content_sam' ) ) {
	/**
	 * Before Content
	 * Wraps all WooCommerce content in wrappers which match the theme markup
	 *
	 ...
	 * @return  void
	 */
	function storefront_before_content_sam() {
		?>
		<main>
			<section id="forth-hover" class="forth-hover">
				<div class="container main-container">
					<div class="row">
						<div class="col-12 col-md-main-9 p-lg-0 pe-lg-3">
							<section id="primary" class="product content-area sam">
		
		<?php
	}
}

if ( ! function_exists( 'storefront_before_content_khos' ) ) {
	/**
	 * Before Content
	 * Wraps all WooCommerce content in wrappers which match the theme markup
	 *
	 ...
	 * @return  void
	 */
	function storefront_before_content_khos() {
		?>
		<main>
			<section id="forth-hover" class="forth-hover">
				<div class="container main-container">
					<div class="row flex-row-reverse">
						<div class="col-12 col-md-main-9 p-lg-0">
							<section id="product" class="product content-area sam">
		<?php
	}
}
...
if ( ! function_exists( 'storefront_after_content_sam' ) ) {
	/**
	 * After Content
	 * Closes the wrapping divs
	 *
	 ...
	 * @return  void
	 */
	function storefront_after_content_sam() {
		?>
			</div>
			<div class="col-12 col-md-main-3">
		<?php
		do_action( 'storefront_sidebar_sam' );
	}
}
if ( ! function_exists( 'storefront_tutor_side_detiled_sam' ) ) {
	/**
	 * After Content
	 * Closes the wrapping divs
	 *
	 ...
	 * @return  void
	 */
	function storefront_tutor_side_detiled_sam() {
		?>
			</div>
			<div class="col-12 col-md-main-3">
		<?php
		do_action( 'storefront_sidebar_tutor_sam' );
	}
}
...
if ( ! function_exists( 'storefront_shop_loop_by_cats' ) ) {
	/**
	 * Sorting wrapper close
	 *
	 * @since   1.4.3
	 * @return  void
	 */
	function storefront_shop_loop_by_cats() {
		$args = array(
			'post_type' => 'product',
			'product_cat_id' => '21',
			'posts_per_page' => 7,
...
if ( ! function_exists( 'storefront_tutor_loop_sam' ) ) {
	/**
	 * Sorting wrapper close
	 *
	 * @since   1.4.3
	 * @return  void
	 */
	function storefront_tutor_loop_sam() {
		$args = array(
			'post_type' => 'courses',
		);
		$productsLoop = new WP_Query($args);
		while ($productsLoop->have_posts()) : $productsLoop->the_post();
                 ...
                 foreach ($cats as $key => $value) {
                     if(strval($value->name) == "ویدئویی"){
                         // echo "done";
                         $secicon = esc_url(home_url('/')) . "wp-content/themes/storefront/assets/images/video.png";
						 $firstProductCat = "ویدئویی";
                     }
                     elseif (strval($value->name) == "صوتی"){
                         $secicon = esc_url(home_url('/')) . "wp-content/themes/storefront/assets/images/audio.png";
						 $firstProductCat = "صوتی";
                     }
                         ...
                         // echo "ویدئویی";
                         $secicon = esc_url(home_url('/')) . "wp-content/themes/storefront/assets/images/txt.png";
						 $firstProductCat = "متنی یا ترکیبی";
                     }
                     if(strval($value->name) == "آموزشی"){
                         // echo "done";
                         $trdicon = esc_url(home_url('/')) . "wp-content/themes/storefront/assets/images/tuts.png";
						 $firstProductCat = $firstProductCat."/"."آموزشی"."/";
                     }
                     elseif (strval($value->name) == "ابزار"){
                         $trdicon = esc_url(home_url('/')) . "wp-content/themes/storefront/assets/images/tuts.png";
						 $firstProductCat = $firstProductCat."/"."آموزشی"."/";
