...
if ( ! class_exists( 'Storefront' ) ) :
	...
	class Storefront {
			...
			register_nav_menus(
				apply_filters(
					...
					array(
						...
						'Left'  => __( 'Left Menu', 'storefront' ),
						'Right'  => __( 'Right Menu', 'storefront' ),
						'footer'  => __( 'Footer Menu', 'storefront' ),
						'socialIcon'  => __( 'Social Menu', 'storefront' ),
		...
		public function widgets_init() {
			...
			$sidebar_args['sidebarB'] = array(
				'name'        => __( 'Sidebar text', 'storefront' ),
				'id'          => 'sidebar-2',
				'description' => 'ساید بار کناری',
			);
			$sidebar_args['sidebarC'] = array(
				'name'        => __( 'Sidebar rand', 'storefront' ),
				'id'          => 'sidebar-3',
				'description' => 'ساید بار کناری',
			);
			$sidebar_args['sidebarD'] = array(
				'name'        => __( 'Sidebar slider', 'storefront' ),
				'id'          => 'sidebar-4',
				'description' => 'ساید بار کناری',
			);
			$sidebar_args['sidebarE'] = array(
				'name'        => __( 'Sidebar fifth', 'storefront' ),
				'id'          => 'sidebar-5',
				'description' => 'ساید بار کناری',
			);
			$sidebar_args['sidebarF'] = array(
				'name'        => __( 'Sidebar six', 'storefront' ),
				'id'          => 'sidebar-6',
				'description' => 'ساید بار کناری',
			);
			$sidebar_args['sidebarg'] = array(
				'name'        => __( 'Sidebar seven', 'storefront' ),
				'id'          => 'sidebar-7',
				'description' => 'ساید بار کناری',
			);
