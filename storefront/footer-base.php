...
<footer>
    ...
    <script src="<?php echo esc_url(home_url('/')); ?>wp-content/themes/storefront/assets/js/swiper-bundle.min.js"></script>
    <script src="<?php echo esc_url(home_url('/')); ?>wp-content/themes/storefront/assets/js/script.js"></script>
